# Super-Hermes Agent Turn Prompt - architecture-room-turn-03-product-owner-agent
...
Input Refs:
- Agent brief: .olympe/runs/g46-adorable-run-001/room-sessions/agent-briefs/architecture-room/product-owner-agent.md
...
- Agent turn execution contract: .olympe/runs/g46-adorable-run-001/room-runtime-adapter/agent-turn-contracts/architecture-room/architecture-room-turn-03-product-owner-agent.json
