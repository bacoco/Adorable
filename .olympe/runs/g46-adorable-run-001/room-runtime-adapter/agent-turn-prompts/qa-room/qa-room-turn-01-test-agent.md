# Super-Hermes Agent Turn Prompt - qa-room-turn-01-test-agent
...
Input Refs:
- Agent brief: .olympe/runs/g46-adorable-run-001/room-sessions/agent-briefs/qa-room/test-agent.md
...
- Agent turn execution contract: .olympe/runs/g46-adorable-run-001/room-runtime-adapter/agent-turn-contracts/qa-room/qa-room-turn-01-test-agent.json
