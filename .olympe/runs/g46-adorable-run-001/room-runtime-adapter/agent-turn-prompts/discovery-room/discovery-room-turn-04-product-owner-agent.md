# Super-Hermes Agent Turn Prompt - discovery-room-turn-04-product-owner-agent
...
Input Refs:
- Agent brief: .olympe/runs/g46-adorable-run-001/room-sessions/agent-briefs/discovery-room/product-owner-agent.md
...
- Agent turn execution contract: .olympe/runs/g46-adorable-run-001/room-runtime-adapter/agent-turn-contracts/discovery-room/discovery-room-turn-04-product-owner-agent.json
