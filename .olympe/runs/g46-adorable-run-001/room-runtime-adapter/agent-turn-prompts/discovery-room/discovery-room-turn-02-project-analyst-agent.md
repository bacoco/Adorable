# Super-Hermes Agent Turn Prompt - discovery-room-turn-02-project-analyst-agent
...
Input Refs:
- Agent brief: .olympe/runs/g46-adorable-run-001/room-sessions/agent-briefs/discovery-room/project-analyst-agent.md
...
- Agent turn execution contract: .olympe/runs/g46-adorable-run-001/room-runtime-adapter/agent-turn-contracts/discovery-room/discovery-room-turn-02-project-analyst-agent.json
