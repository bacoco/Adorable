# Super-Hermes Agent Turn Prompt - intake-room-turn-04-project-analyst-agent
...
Input Refs:
- Agent brief: .olympe/runs/g46-adorable-run-001/room-sessions/agent-briefs/intake-room/project-analyst-agent.md
...
- Agent turn execution contract: .olympe/runs/g46-adorable-run-001/room-runtime-adapter/agent-turn-contracts/intake-room/intake-room-turn-04-project-analyst-agent.json
