# Super-Hermes Agent Turn Prompt - intake-room-turn-05-repo-knowledge-agent

Room: intake-room
Agent: repo-knowledge-agent
Turn index: 5
Invitation scope: invited
Source repo: freestyle-sh/adorable (read-only)
Working repo: bacoco/adorable

Input Refs:
- Agent brief: .olympe/runs/g46-adorable-run-001/room-sessions/agent-briefs/intake-room/repo-knowledge-agent.md
...
- Agent turn execution contract: .olympe/runs/g46-adorable-run-001/room-runtime-adapter/agent-turn-contracts/intake-room/intake-room-turn-05-repo-knowledge-agent.json
