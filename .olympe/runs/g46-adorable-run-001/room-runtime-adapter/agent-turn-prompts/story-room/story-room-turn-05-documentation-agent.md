# Super-Hermes Agent Turn Prompt - story-room-turn-05-documentation-agent
...
Input Refs:
- Agent brief: .olympe/runs/g46-adorable-run-001/room-sessions/agent-briefs/story-room/documentation-agent.md
...
- Agent turn execution contract: .olympe/runs/g46-adorable-run-001/room-runtime-adapter/agent-turn-contracts/story-room/story-room-turn-05-documentation-agent.json
