...
Classer, dedoublonner, prioriser et router les demandes entrantes vers la bonne suite (room, Hermes, maturite).
...
- une demande sort de l intake-room ;
- plusieurs demandes similaires arrivent ;
- une demande n a pas de destination claire.

## Environnement principal

Cadrage (Hermes Cadrage / Produit).

## Rooms concernees

- intake-room (appui) ;
- triage-room (responsable).

## Entrees

- fiche besoin initiale ;
- backlog ou demandes existantes ;
- 
